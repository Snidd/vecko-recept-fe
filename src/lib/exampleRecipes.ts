    ...
    return [
        {
            ...
            other_ingredients: [
                { ingredient_row: "Salt and pepper to taste", id: 1 }
            ],
            instructions: "Cook spaghetti according to package instructions. In a separate pan, cook ground beef and onion until browned. Combine with spaghetti and season with salt and pepper."
        },
        {
            id: 2,
            ...
            other_ingredients: [
                { ingredient_row: "Olive oil and vinegar dressing", id: 2 }
            ],
            instructions: "Grill chicken breast until cooked through. Slice and serve over mixed greens and cherry tomatoes, drizzled with olive oil and vinegar dressing."
        },
        {
            id: 3,
            image_url: "https://example.com/recipe3.jpg",
            ...
            other_ingredients: [
                { ingredient_row: "Sesame seeds for garnish", id: 3 }
            ],
            instructions: "Stir fry mixed vegetables and tofu in a pan. Add soy sauce and cook until heated through. Garnish with sesame seeds."
        },
        {
            id: 4,
            ...
            other_ingredients: [
                { ingredient_row: "Lettuce and salsa for topping", id: 4 }
            ],
            instructions: "Cook ground beef in a pan until browned. Fill taco shells with beef, cheese, lettuce, and salsa."
        },
        {
            id: 5,
            ...
            other_ingredients: [
                { ingredient_row: "Honey to taste", id: 5 }
            ],
